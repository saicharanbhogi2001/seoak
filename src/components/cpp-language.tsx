            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/c++language.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                  ...
                  <div className="tab-content tab-content-info">
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          C++ is a powerful programming language that builds
                          upon the foundation of C with additional features such
                          as object-oriented programming and generic
                          programming. It is widely used in various domains,
                          including software development, game development,
                          embedded systems, and high-performance applications.
                          C++ provides a balance between low-level control and
                          high-level abstractions, making it a popular choice
                          for developing complex and efficient software
                          solutions.
                        </p>
                        <p>
                          The C++ Programming Essentials course is designed to
                          provide students with a comprehensive understanding of
                          the C++ programming language. This course is suitable
                          for beginners who have a basic knowledge of
                          programming concepts. Students will learn the syntax,
                          features, and techniques of C++, including
                          object-oriented programming (OOP) and generic
                          programming. Through practical exercises and coding
                          projects, students will develop the skills necessary
                        ...
                        <ul>
                          <li>
                            <i className="fas fa-check-double" /> 7-10 hours of
                            content!
                          </li>
                          <li>
