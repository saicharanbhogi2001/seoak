            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/dsa.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          concepts in computer science and programming. Data
                          structures are used to organize and store data
                          efficiently, while algorithms are step-by-step
                          procedures for solving problems and manipulating data.
                          Understanding data structures and algorithms is
                          essential for designing efficient and optimized
                          software solutions. This knowledge helps programmers
                          make informed decisions about choosing the right data
                          structures and implementing efficient algorithms to
                          solve complex problems.
                        </p>
                        <p>
                          This course is suitable for individuals who want to
                          enhance their programming skills and learn how to
                          design efficient and scalable algorithms. Practical
                          implementation and analysis of algorithms will be
                          emphasized through programming assignments and
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>
                                          Introduction of Data Structure And
                                          Algorithm
                                        </h5>
                                      </div>
