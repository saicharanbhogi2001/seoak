            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/powerbi.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          visualization tool developed by Microsoft. It enables
                          users to transform raw data into interactive
                          visualizations, gain insights, and share them with
                          others. Power BI is widely used in various industries
                          to analyze and present data in a visually appealing
                          and easily understandable format. The Power BI
                          Fundamentals course provides a comprehensive
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of Power BI</h5>
                                      </div>
