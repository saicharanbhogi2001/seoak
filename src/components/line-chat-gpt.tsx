            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/CHATGPT.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          by OpenAI. It is powered by GPT-3.5, an advanced
                          deep-learning architecture, and is designed to
                          generate human-like responses and engage in
                          interactive conversations with users. ChatGPT can
                          provide information, answer questions, assist with
                          tasks, and engage in natural language conversations
                          across a wide range of topics. It leverages a vast
                          amount of knowledge and contextual understanding to
                          deliver meaningful and coherent responses.
                        </p>
                        <p>
                          The ChatGPT Fundamentals course provides students with
                          an understanding of the capabilities and usage of
                          ChatGPT for various applications. This course is
                          suitable for individuals interested in learning about
                          natural language processing and conversational AI.
                          Through hands-on exercises and projects, students will
                          gain practical experience in utilizing ChatGPT for
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of Chat-GPT</h5>
                                      </div>
