            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/advancedai.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          applications of artificial intelligence (AI) that go
                          beyond the fundamentals. It involves utilizing complex
                          algorithms, deep learning architectures, and
                          cutting-edge technologies to solve challenging
                          problems and achieve high levels of performance in AI
                          systems. Advanced AI techniques include deep learning,
                          natural language processing, computer vision,
                          reinforcement learning, and generative models. It
                          finds applications in various fields, such as
                          healthcare, finance, robotics, and autonomous systems.
                        </p>
                        <p>
                          The Advanced AI Concepts and Techniques course
                          provides students with a comprehensive understanding
                          of advanced AI methodologies and their applications.
                          Through hands-on projects and case studies, students
                          will gain practical experience in applying advanced AI
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of Advanced AI</h5>
                                      </div>
