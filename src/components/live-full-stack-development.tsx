const LiveFullStackDevelopment = () => {
  return (
    <>
            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  <div className="thumb">
                    <img
                      src="assets/img/fullstackwebdevelopment.png"
                      alt="Thumb"
                    />
                  </div>
                  {/* End Thumbnail */}
                  ...
                  <div className="tab-content tab-content-info">
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          Full Stack Web Development refers to the ability to
                          develop both the front-end and back-end components of
                          a web application. A Full Stack Web Developer is
                          proficient in both client-side technologies (HTML,
                          CSS, JavaScript) for designing user interfaces and
                          server-side technologies (such as Node.js, Python, or
                          PHP) for handling data and business logic. Full Stack
                          Web Developers have a comprehensive understanding of
                          the entire web development process, from concept to
                          deployment.
                        </p>
                        <p>
                          The Full Stack Web Development course provides
                          students with the skills and knowledge necessary to
                          develop dynamic and interactive web applications. This
                          course covers both front-end and back-end technologies
                          and emphasizes hands-on learning through projects and
                          practical exercises.
                        </p>
                        <h4>Certification</h4>
                        <p>
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>
                                          Introduction of Full Stack Development
                                        </h5>
                                      </div>
...
export default LiveFullStackDevelopment;
