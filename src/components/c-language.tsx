              ...
              <div className="container">
                <div className="row item-flex center">
                  <div className="col-md-5 thumb">
                    {/* <img src="assets/img/person.png" alt="Thumb"> */}
            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  {/* Title*/}
                  <div className="title">
                    <h2>C Language Programming - Advanced</h2>
                  </div>
                  {/* End Title*/}
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/clanguage.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          known for its efficiency, low-level capabilities, and
                          portability. It serves as the foundation for many
                          other programming languages and is commonly used in
                          systems programming, embedded systems development,
                          game development, and more. With its extensive
                          libraries and direct access to hardware, C is an
                          essential language for building high-performance
                          applications.
                        </p>
                        <h4>Certification</h4>
                        <p>
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of C Language</h5>
                                      </div>
