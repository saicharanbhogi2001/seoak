            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/pythonprogramming.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          vast ecosystem of libraries and frameworks. It is used
                          in various domains, including web development, data
                          analysis, machine learning, and automation. Python's
                          intuitive syntax and extensive library support make it
                          an ideal choice for beginners and experienced
                          programmers alike.
                        </p>
                        <p>
