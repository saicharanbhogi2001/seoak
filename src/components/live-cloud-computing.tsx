            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/cloudcomputing.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                  ...
                  <div className="tab-content tab-content-info">
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          Cloud Computing is a paradigm that involves delivering
                          computing resources, such as servers, storage,
                          databases, and software, over the internet. It enables
                          businesses and individuals to access and utilize
                          scalable and on-demand computing infrastructure
                          without the need for significant upfront investment in
                          hardware and maintenance. Cloud Computing offers
                          flexibility, scalability, cost-effectiveness, and ease
                          of management, making it a vital technology in various
                          industries.
                        </p>
                        <p>
                          The Cloud Computing Fundamentals course provides
                          students with a comprehensive understanding of the
                          core concepts and principles of cloud computing. This
                          course is suitable for individuals who want to gain
                          knowledge of cloud computing and its applications in
                          various domains. Students will learn about different
                          ...
                          essential cloud technologies and tools.
                        </p>
                        <h4>Certification</h4>
                        <p>
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of Cloud Computing</h5>
                                      </div>
...
export default LiveCloudComputing;
