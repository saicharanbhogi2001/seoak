            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/javaprogramming.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          its versatility, stability, and scalability. It is
                          extensively used in various domains such as web
                          development, mobile app development, enterprise
                          software, and more. With its robustness and
                          compatibility, Java continues to be a popular choice
                          for developing high-performance applications. As a
                          Java Developer, you will be responsible for designing,
                          developing, and maintaining Java-based applications.
                          Your role will involve collaborating with
                          cross-functional teams, understanding business
                          requirements, and translating them into efficient and
                          scalable software solutions. You will leverage your
                          expertise in Java programming, object-oriented design
                          principles, and software development best practices to
                        ...
                        <ul>
                          <li>
                            <i className="fas fa-check-double" /> 15 hours of
                            content!
                          </li>
                          <li>
