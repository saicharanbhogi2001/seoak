            ...
            <div className="col-md-8">
              <div className="course-details-info">
                ...
                <div className="top-info">
                  ...
                  {/* Thumbnail */}
                  <div className="thumb">
                    <img src="assets/img/datascience.png" alt="Thumb" />
                  </div>
                  {/* End Thumbnail */}
                  {/* Course Meta */}
                ...
                <div className="tab-info">
                  ...
                  <div className="tab-content tab-content-info">
                    ...
                    <div id="tab1" className="tab-pane fade active in">
                      <div className="info title">
                        ...
                        <p>
                          ...
                          combines statistics, mathematics, programming, and
                          domain expertise to extract valuable insights and
                          knowledge from data. It involves analyzing and
                          interpreting large volumes of data to make informed
                          business decisions, solve complex problems, and drive
                          innovation. Data Science has applications in various
                          industries, including finance, healthcare, marketing,
                          and technology. The Data Science Fundamentals course
                          provides students with a comprehensive understanding
                          of the core concepts and techniques used in data
                          science.
                        </p>
                        <h4>Certification</h4>
                        <p>
                    ...
                    <div id="tab2" className="tab-pane fade">
                      <div className="info title">
                        <p>
                          The Data Science Fundamentals course provides students
                          with a comprehensive understanding of the core
                          concepts and techniques used in data science.
                        </p>
                                  ...
                                  <ul>
                                    <li>
                                      ...
                                      <div className="item title">
                                        <h5>Introduction of Data Science</h5>
                                      </div>
...
export default LiveDataScience;
